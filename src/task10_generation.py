...
def generate_with_citation(query: str, top_k: int = TOP_K, search_query: str = None, chat_history: list = None) -> dict:
    """
    ...
    Args:
        ...
        search_query: Câu query dùng để search (nếu dùng HyDE)
    ...
    """
    # Step 1: Retrieve
    chunks = retrieve(query=query, top_k=top_k, search_query=search_query)
